...
public class AdminSecretController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminSecretController.class);
    ...
    public String listTagForm(Model model) {
        ...
        model.addAttribute("category_srl_secret", confAdmin.getProperty("plymind.secret.category.srl"));

        return "f_admin/plymind/secret/secret_list";
    }
    ...
    public ModelAndView listDocument(HttpServletRequest request,
        ...
        String strCategorySrl = confAdmin.getProperty("plymind.secret.category.srl");
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_admin/plymind/secret/secret_detail0";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/secret/secret_add";
    }

...
public class SecretController {
    private final static Logger LOG = LoggerFactory.getLogger(SecretController.class);
    ...
    public String listForm(Model model) {
        ...
        return "f_service/plymind/secret/secret_list";
    }
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_service/plymind/secret/secret_detail0";
    }
    ...
    public String modifyDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_service/plymind/secret/secret_modify";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_service/plymind/secret/secret_add";
    }
}
...
public class AdminNoticeController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminNoticeController.class);
    ...
    public String listTagForm(Model model) {
        ...
        model.addAttribute("category_srl_notice", confAdmin.getProperty("plymind.notice.category.srl"));

        return "f_admin/plymind/notice/notice_list";
    }
    ...
    public ModelAndView listDocument(HttpServletRequest request,
        ...
        String strCategorySrl = confAdmin.getProperty("plymind.notice.category.srl");
    ...
    public String detailDocument(@PathVariable("document_srl") long documentSrl,
        ...
        return "f_admin/plymind/notice/notice_detail";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/notice/notice_add";
    }
}

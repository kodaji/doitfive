...
/**
 * Created by je7646 on 16. 1. 19.
 */
@Controller
@RequestMapping("/admin/theme")
public class AdminThemeController {
    private final static Logger LOG = LoggerFactory.getLogger(AdminThemeController.class);
    ...
    public String listTagForm(Model model) {
        ...
        return "f_admin/plymind/theme/theme_list";
    }
    ...
    public String addDocumentForm(Model model) {
        ...
        return "f_admin/plymind/theme/theme_add";
    }
    ...
    public String detailDocument(HttpServletRequest request,
        ...
        return "f_admin/plymind/theme/theme_detail";
    }

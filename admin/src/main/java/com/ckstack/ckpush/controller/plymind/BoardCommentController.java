 ...
 */
@Controller
@RequestMapping("/user/board/document/comment")
public class BoardCommentController {
    private final static Logger LOG = LoggerFactory.getLogger(BoardCommentController.class);
    ...
    public ModelAndView addDocumentComment(HttpServletRequest request,
        ...
        //documentService.getCommentCount(documentCommentEntity.getDocument_srl());

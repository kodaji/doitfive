 ...
 */
public class PlymindUserDetailsService implements UserDetailsService {
    private final static Logger LOG = LoggerFactory.getLogger(PlymindUserDetailsService.class);

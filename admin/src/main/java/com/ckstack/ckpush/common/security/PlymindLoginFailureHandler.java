 ...
 */
public class PlymindLoginFailureHandler implements AuthenticationFailureHandler {
    private final static Logger LOG = LoggerFactory.getLogger(PlymindLoginFailureHandler.class);
